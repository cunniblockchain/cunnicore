# Support for Output Descriptors in Cunni Core

Since Cunni Core v0.17, there is support for Output Descriptors. This is a
...
existing Cunni Core wallets, a convenience function `combo` is
...
All RPCs in Cunni Core will include the checksum in their output. Only
