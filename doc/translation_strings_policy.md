...
This document provides guidelines for internationalization of the Cunni Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cunni_en.ts` remains unchanged.
