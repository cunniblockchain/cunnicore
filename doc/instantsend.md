...
This mechanism has been integrated into Bitcore-Node-Cunni which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cunnipay/insight-api-cunni#web-socket-api](https://github.com/cunnipay/insight-api-cunni#web-socket-api)
* API: [https://github.com/cunnipay/insight-api-cunni#instantsend-transactions](https://github.com/cunnipay/insight-api-cunni#instantsend-transactions)
