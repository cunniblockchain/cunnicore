...
from test_framework.messages import cunnihash, hash256
...
def cunnihash_reversed(byte_str):
    return cunnihash(byte_str)[::-1]
...
class ZMQTest (BitcoinTestFramework):
    ...
    def _zmq_test(self):
        ...
        for x in range(num_blocks):
            ...
            assert_equal(genhashes[x], cunnihash_reversed(block[:80]).hex())
