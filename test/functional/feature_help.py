...
"""Verify that starting cunnid with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cunnid with -h for help text")
        ...
        self.log.info("Start cunnid with -version for version information")
        ...
        self.log.info("Start cunnidd with -fakearg to make sure it does not start")
