# Bootstrappable Cunni Core Builds

This directory contains the files necessary to perform bootstrappable Cunni
Core builds.
...
To build Cunni Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Cunni Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/cunni-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/cunnipay/guix.sigs).
...
[guix-docker]: https://github.com/cunniblockchain/cunnicore/tree/master/contrib/guix/Dockerfile
