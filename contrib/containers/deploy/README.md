...
official/supported Docker Images found at https://hub.docker.com/r/cunnipay/cunnid/
...
**NOTE: Please update the image description at https://hub.docker.com/r/cunnipay/cunnid-develop/ when changing the above text**