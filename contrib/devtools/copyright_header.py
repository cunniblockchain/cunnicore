...
Arguments:
    <base_directory> - The base directory of a Cunni Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Cunni Core developers'
...
Arguments:
    <base_directory> - The base directory of Cunni Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Cunni Core repository.
"""
