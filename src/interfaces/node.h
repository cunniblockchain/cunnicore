...
//! Interface for the src/evo part of a cunni node (cunnid process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a cunni node (cunnid process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a cunni node (cunnid process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a cunni node (cunnid process).
...
//! Top-level interface for a cunni node (cunnid process).
class Node
{
public:
    virtual ~Node() {}
