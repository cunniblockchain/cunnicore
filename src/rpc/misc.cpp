...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"cunni\" activates all Cunni-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "cunni")
    + HelpExampleRpc("debug", "cunni+net")
    }}.Check(request);
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The cunni address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    RPCHelpMan{"verifymessage",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The cunni address to use for the signature."},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The difference of Cunnitoshi"},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The number of Cunnitoshi of the output"},
...
static UniValue getaddressbalance(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddressbalance",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
                {
                    {RPCResult::Type::NUM, "balance", "The current total balance in Cunnitoshi"},
                    {RPCResult::Type::NUM, "balance_immature", "The current immature balance in Cunnitoshi"},
                    {RPCResult::Type::NUM, "balance_spendable", "The current spendable balance in Cunnitoshi"},
                    {RPCResult::Type::NUM, "received", "The total number of Cunnitoshi received (including change)"},
                }},
        RPCExamples{
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "cunni-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Cunni features */
    { "cunni",               "mnsync",                 &mnsync,                 {} },
    { "cunni",               "spork",                  &spork,                  {"command"} },
    { "cunni",               "sporkupdate",            &sporkupdate,            {"name","value"} },
