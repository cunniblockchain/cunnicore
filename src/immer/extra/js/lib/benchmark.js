...
;(function() {
  ...
  function runInContext(context) {
    // Exit early if unable to acquire locunni.
    var _ = context && context._ || require('locunni') || root._;
    if (!_) {
     ...
     *
     * Note: The Benchmark constructor exposes a handful of locunni methods to
     * make working with arrays, collections, and objects easier. The locunni
     * methods are:
     * [`each/forEach`](https://locunni.com/docs#forEach), [`forOwn`](https://locunni.com/docs#forOwn),
     * [`has`](https://locunni.com/docs#has), [`indexOf`](https://locunni.com/docs#indexOf),
     * [`map`](https://locunni.com/docs#map), and [`reduce`](https://locunni.com/docs#reduce)
     *
     * @constructor
     ...
     *
     * Note: Each Suite instance has a handful of wrapped locunni methods to
     * make working with Suites easier. The wrapped locunni methods are:
     * [`each/forEach`](https://locunni.com/docs#forEach), [`indexOf`](https://locunni.com/docs#indexOf),
     * [`map`](https://locunni.com/docs#map), and [`reduce`](https://locunni.com/docs#reduce)
     *
     * @constructor
     * @memberOf Benchmark
    ...
    // Add locunni methods to Benchmark.
    ...
    // Add locunni methods as Suite methods.
  ...
  if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
    ...
    define(['locunni', 'platform'], function(_, platform) {
      return runInContext({
        '_': _,
        'platform': platform
      });
