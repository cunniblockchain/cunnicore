 ...
 *  We have 4 times smaller block times in Cunni, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        Cunni Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // CUN this code also handles non-TXs (Cunni specific messages)
