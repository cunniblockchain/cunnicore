 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1730224285, nBits=1e0ffff0, nNonce=1787621, vtx=1)
...
{
    const char* pszTimestamp = "Bitcoin creator vanished leaving questions and possibilities";
    const CScript genesisOutputScript = CScript() << ParseHex("04c485f72a09bda4533b948254f81027e5c5f7a58701bad0a10c50f77b819b9b8766b3d7b22f8deb9f0d296b42eed15930d4c7368fabab1d7bcef039a213d12be5") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000686076b320d55d56982d4a285a8d03cb044aeef7e8ff7a7592488808102"); 
        ...
        genesis = CreateGenesisBlock(1730224285, 1787621, 0x1e0ffff0, 1, 75 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000686076b320d55d56982d4a285a8d03cb044aeef7e8ff7a7592488808102"));
        assert(genesis.hashMerkleRoot == uint256S("0x965d754a1511e7a883488dc90be1180d5d6c2c63dad5393913f73a759e64aa0e"));
        ...
        // Cunni BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Cunni BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // Cunni BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"CRfEbqD6jN8E9wTTvPasaNCt5yJssyTsjW"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x00000686076b320d55d56982d4a285a8d03cb044aeef7e8ff7a7592488808102")},
            }
        };
        ...
        // getchaintxstats 17280 00000686076b320d55d56982d4a285a8d03cb044aeef7e8ff7a7592488808102
        chainTxData = ChainTxData{
                1730224285, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000eb4e7bff23d900444d80d8e453a39b78087c2a343c75867486182c001d0"); 
        ...
        genesis = CreateGenesisBlock(1730224290UL, 1180262UL, 0x1e0ffff0, 1, 75 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000eb4e7bff23d900444d80d8e453a39b78087c2a343c75867486182c001d0"));
        assert(genesis.hashMerkleRoot == uint256S("0x965d754a1511e7a883488dc90be1180d5d6c2c63dad5393913f73a759e64aa0e"));
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,156);
        // Testnet Cunni BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Cunni BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Cunni BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"CMgeJ1J9N2SFEidnFky9qjZ8NL3Q7iKPJv"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x00000eb4e7bff23d900444d80d8e453a39b78087c2a343c75867486182c001d0")},
            }
        };
        ...
        // getchaintxstats 17280 00000eb4e7bff23d900444d80d8e453a39b78087c2a343c75867486182c001d0
        chainTxData = ChainTxData{
                1730224290, // * UNIX timestamp of last known number of transactions
                0,    // * total number of transactions between genesis and that timestamp
                            //   (the tx=... number in the ChainStateFlushed debug.log lines)
                0,       // * estimated number of transactions per second after that timestamp
        };
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1730224295, 0, 0x207fffff, 1, 75 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x5269d4e0fcb7f4fbd117215e7f4d47c1705927a239fcacb9e4455863c9b6edc7"));
        assert(genesis.hashMerkleRoot == uint256S("0x965d754a1511e7a883488dc90be1180d5d6c2c63dad5393913f73a759e64aa0e"));

        devnetGenesis = FindDevNetGenesisBlock(genesis, 75 * COIN);
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x5269d4e0fcb7f4fbd117215e7f4d47c1705927a239fcacb9e4455863c9b6edc7")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // privKey: 6FcmBbYo4QFkETzsp3wAxWeK4stuKKacZD9urr8TdAFUmFEXzG3
        vSporkAddresses = {"CN6ygsZTSD2HmJgPuYjyD18cbCwaAxcbL5"};
        nMinSporkKeys = 1;
        ...
        // Regtest Cunni addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,28);
        // Regtest Cunni script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,29);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,156);
        // Regtest Cunni BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Cunni BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Cunni BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
