...
/** Utility functions used by the Cunni Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "cunni:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load cunni specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a cunni specific theme is activated (light/dark).*/
